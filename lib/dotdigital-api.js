...
class DotdigitalApi {
  ...
  async putProductById (id, collection, data) {
    return await this.put(`/insightData/v3/account/${collection}/${id}`, data)
  }
  ...
  async putOrderById (contactEmail, orderData) {
    return await this.put(`/insightData/v3/contacts/email/${contactEmail}/Orders/${orderData.id}`, orderData)
  }
}
