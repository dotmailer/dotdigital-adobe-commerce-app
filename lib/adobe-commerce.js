 ...
 * @returns {Promise} Configured Got instance for making HTTP requests
 */
...
async function getAdobeCommerceClient (params) {
  ...
  // check if COMMERCE_CONSUMER_KEY is correctly set for local testing using aio app dev
...
module.exports = { getAdobeCommerceClient, webhookVerify }
